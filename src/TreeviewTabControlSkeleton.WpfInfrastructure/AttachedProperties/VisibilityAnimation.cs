...
namespace TreeviewTabControlSkeleton.WpfInfrastructure.AttachedProperties
{
    /*
         https://stackoverflow.com/questions/25460211/animation-on-visiblity-change-property-was-already-registered-by-frameworkele/25545871
         http://blogs.microsoft.co.il/blogs/arik/VisibilityAnimation.cs.txt
    */
    public class VisibilityAnimation
    {
            ...
            object baseValue)
        {
            ...
            // Start animation
            frameworkElement.BeginAnimation(UIElement.OpacityProperty, doubleAnimation, HandoffBehavior.Compose);
